...
class HomePage extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Center(child: Text('Hortifruti'))),
        body: controller.obx(
          (state) => ListView(
            children: [
              for (var store in state!)
                ListTile(
                  ...
                  trailing: Container(
                    ...
                    child: Text(store.isOnline ? 'Aberto' : 'Fechado',
          ...
          onEmpty: Center(
            child: Text(
              "Não tem nenhum estabelecimento disponível para sua localização.",
            ),
          ),
        ));
  }
